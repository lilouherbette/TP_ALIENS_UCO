Apres avoir cliqué sur la version RAW du fichier MaBase_MIB.py présent sur ce répertoire, enregistrez-le sur votre répertoire personnel distant (sur github) et sur votre propre machine.

Répondez ensuite aux questions suivantes en utilisant le fichier MaBase_MIB.py (des réponses sont donnéespour vous aider). Pour cela créez un fichier MIB_exos.py qui commencera ainsi:
...
On pourra travailler en Python par exemple dans l'environnement Anaconda.
